...
public class Config {
    ...
    public boolean chatLog = true, chatHidePacket = true; public int chatWidth = 0, chatMaxMessages = 100; public String chatNameFormat = "<$>";
    public int shiftChat = 10; public boolean messageDrafting = false, searchDrafting = true, hideSearchButton = false;
